// Code from https://github.com/V-ed/quoted-string-space-split
 ...
 */
export function splitSpacesExcludeQuotesDetailed(
  string: string
): ParsedValue[] {
...
export function splitSpacesExcludeQuotes(string: string): string[] {
  return splitSpacesExcludeQuotesDetailed(string).map(
